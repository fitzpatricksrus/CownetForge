package us.cownet.examplemod.expodingsheep;

import us.cownet.examplemod.utilities.commands.*;
...
public class ExplodingAnimals implements HackFMLEventListener {
	...
	private static final TriggerInfo[] triggers = {
			...
			new TriggerInfo("cow", EntityCow.class, "minecraft:beef", "cownetmod:emp_round"),
			...
			new TriggerInfo("sheep", EntitySheep.class, "minecraft:mutton", "cownetmod:raw_uru"),
